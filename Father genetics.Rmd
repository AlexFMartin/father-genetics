...
### Model 1
1. Father parenting <- father PRS
controls: child sex, mother PRS

2. Father and mother PRS correlation (assortative mating)
Father and mother parenting correlation

3. Father parenting <- child PRS
controls: child sex, mother PRS

4. Father parenting <- father PRS; child PRS
controls: child sex, mother PRS
